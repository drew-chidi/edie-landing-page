...
const Services = () => {
  return (
    <div className='mt-24 block text-left  xl:pl-40'>
      <h2 className='pl-8 text-lg xs:text-2xl font-medium leading-9 sm:pl-16 sm:text-3xl lg:text-4xl xl:pl-0 xl:leading-[56px]'>
        We offer high <br />
        demand services
      </h2>
      ...
      <div className='xl:flex'>
        ...
        <div className='mt-24 pl-8 sm:pl-16 xl:mt-28 pt-12 pb-11 '>
          ...
          <h3 className='font-bold text-lg xs:text-2xl leading-9 text-[#333] mb-6'>
            UI/UX Design
          </h3>
          ...
          <button
            type='submit'
            className='px-3 h-[42px] bg-gray-300 text-base text-[#828282] leading-6 rounded-xl font-medium'
          >
            Get Started
          </button>
        </div>
        ...
        <div className='mt-28 pl-8 shadow-lg rounded-[24px] pt-12 pb-11 bg-white sm:pl-16'>
          ...
          <button
            type='submit'
            className='px-3 h-[42px] bg-blue-400 text-base text-white leading-6 rounded-xl font-medium'
          >
            Get Started
          </button>
        </div>
